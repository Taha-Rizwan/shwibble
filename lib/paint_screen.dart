...
import 'package:shwibble/final_leaderboard.dart';
import 'package:shwibble/home_screen.dart';
import 'package:shwibble/models/my_custom_painter.dart';
import 'package:shwibble/models/touch_points.dart';
import 'package:shwibble/sidebar/player_scoreboard_drawer.dart';
import 'package:shwibble/waiting_lobby_screen.dart';
...
class _PaintScreenState extends State<PaintScreen> {
  ...
  void connect() {
    _socket = IO.io('https://shwibble.herokuapp.com', <String, dynamic>{
